    ...
    const fetchHomes = async () => {
      try {
        const response = await axios.post(
          "https://6738e54f5a707db9a2f0e146--lively-fox-249240.netlify.app/api/v1/users/allhomes"
        );
  ...
  const handleViewDetails = (homeId) => {
    ...
    if (user) {
      ...
      navigate("/login", {
        state: {
          from: "view-details",
          message: "Please log in to view the details.",
        },
      });
    }
  };
            ...
            >
              ...
              <div className="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
                ...
                <p className="text-xl font-semibold text-gray-700 dark:text-gray-300">
                  <span className="text-red-500 dark:text-red-300">Title:</span>
                  <span className="text-gray-900 dark:text-gray-100">
                    {pg.title}
                  </span>
                </p>
